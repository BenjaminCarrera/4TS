...
export class CandidatoUpdateComponent implements OnInit {
  ...
  updateForm(candidato: ICandidato) {
    this.editForm.patchValue({
      ...
      fechaAlta: candidato.fechaAlta ? candidato.fechaAlta.toDate() : null,
      fechaUltimoSeguimiento: candidato.fechaUltimoSeguimiento ? candidato.fechaUltimoSeguimiento.toDate() : null,
      foto: candidato.foto,

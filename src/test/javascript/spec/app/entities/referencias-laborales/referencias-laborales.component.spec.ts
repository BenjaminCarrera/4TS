...
import { ReferenciasLaboralesComponent } from 'app/entities/referencias-laborales/referencias-laborales.component';
...
describe('Component Tests', () => {
  describe('ReferenciasLaborales Management Component', () => {
    let comp: ReferenciasLaboralesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReferenciasLaboralesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ReferenciasLaborales(123)],
            headers
          })
        )
      );
      ...
      expect(comp.referenciasLaborales[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

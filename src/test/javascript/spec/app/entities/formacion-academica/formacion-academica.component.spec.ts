...
import { FormacionAcademicaComponent } from 'app/entities/formacion-academica/formacion-academica.component';
...
describe('Component Tests', () => {
  describe('FormacionAcademica Management Component', () => {
    let comp: FormacionAcademicaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FormacionAcademicaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new FormacionAcademica(123)],
            headers
          })
        )
      );
      ...
      expect(comp.formacionAcademicas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { ColoniaComponent } from 'app/entities/colonia/colonia.component';
  ...
  describe('Colonia Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ColoniaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.colonias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { BitacoraComponent } from 'app/entities/bitacora/bitacora.component';
...
describe('Component Tests', () => {
  describe('Bitacora Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bitacoras[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

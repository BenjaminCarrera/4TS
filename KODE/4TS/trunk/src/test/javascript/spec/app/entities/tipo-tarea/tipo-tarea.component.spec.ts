...
import { TipoTareaComponent } from 'app/entities/tipo-tarea/tipo-tarea.component';
...
describe('Component Tests', () => {
  describe('TipoTarea Management Component', () => {
    let comp: TipoTareaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TipoTareaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tipoTareas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

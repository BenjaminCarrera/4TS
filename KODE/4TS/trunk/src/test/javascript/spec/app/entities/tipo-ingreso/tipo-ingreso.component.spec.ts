...
import { TipoIngresoComponent } from 'app/entities/tipo-ingreso/tipo-ingreso.component';
...
describe('Component Tests', () => {
  describe('TipoIngreso Management Component', () => {
    let comp: TipoIngresoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TipoIngresoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tipoIngresos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

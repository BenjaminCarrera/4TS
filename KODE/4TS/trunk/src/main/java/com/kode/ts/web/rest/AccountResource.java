...
import com.kode.ts.service.dto.PasswordChangeDTO;
import com.kode.ts.service.dto.UserDTO;
import com.kode.ts.web.rest.errors.*;
import com.kode.ts.web.rest.vm.KeyAndPasswordVM;
import com.kode.ts.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
            userDTO.getLangKey(), userDTO.getImageUrl(), userDTO.getSecondName(), userDTO.getIniciales());
    }

...
/**
 * REST controller for managing {@link com.kode.ts.domain.Municipio}.
 */
@RestController
@RequestMapping("/api")
public class MunicipioResource {
    ...
    public ResponseEntity<List<MunicipioDTO>> getAllMunicipios(MunicipioCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
